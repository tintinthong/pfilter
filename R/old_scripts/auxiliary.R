...
#run particle filter
obj.randw<-auxiliary.filter(N=N,x=x,y=y,x0=x0,sigma=sigma,sigma.meas=sigma.meas,
                           resample.type="standard")
...
MSE<-matrix(NA,tau,M)
for(k in 1:M){
  obj.randw<-auxiliary.filter(N=N,x=x,y=y,x0=x0,sigma=sigma,sigma.meas=sigma.meas,resample.type="standard")
...
#run particle filter
obj.pop<-auxiliary.filter.pop(N=N,x=x,y=y,x0=x0,sigma=sigma,
                             sigma.meas=sigma.meas,resample.type="standard")
...
MSE<-matrix(NA,tau,M)
for(k in 1:M){
  obj.pop<-auxiliary.filter.pop(N=N,x=x,y=y,x0=x0,sigma=sigma,sigma.meas=sigma.meas,resample.type="standard")
